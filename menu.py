...
Press f: Exit to main menu""")
        ...
        if dc=='a':
            ...
            print("""\nPress a: To Launch ec2
Press b: To Describe ec2
Press c: To Start ec2
Press d: To Stop ec2
Press e: To Terminate ec2
Press f: To Exit the AWS Menu""")
...
Press 12: Start an installed service
Press 13: Stop a running service
Press 0 : Exit to Main Menu""")
    main_choice=int(input("Enter you choice : "))
...
while True:
    ...
    os.system("tput sgr0")
    os.system("tput rmul")
    print("""\nPress 1 : For General Redhat 
Press 2: Docker
Press 3: Drives and Partition Management
Press 4: AWS
Press 5: Hadoop
Press 0 : Exit""")
